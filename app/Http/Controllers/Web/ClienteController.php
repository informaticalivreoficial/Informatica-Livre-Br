    ...
    public function pagar($uuid)
    {
        ...
        if($fatura->gateway == 2){
            $data = [
                ...
                'payer_cpf_cnpj' => str_replace(['.','-','/'], "", ($fatura->pedidoObject->getEmpresa->document_company != null ? $fatura->pedidoObject->getEmpresa->document_company : $fatura->pedidoObject->getEmpresa->owner->cpf)),
