<header class="w-full bg-white shadow-sm sticky top-0 z-50">
    ...
    <nav x-data="{ open: false }" class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center gap-8">
            ...
            <a href="{{ route('web.consultoria') }}" class="bg-teal-600 text-white px-5 py-2 rounded-lg hover:bg-teal-700 transition font-medium">
                Solicitar Orçamento
            </a>
        </div>
        ...
        >
            <div class="flex flex-col px-4 py-4 gap-4">
                ...
                <a href="{{ route('web.consultoria') }}" class="bg-teal-600 text-white px-5 py-2 rounded-lg text-center font-medium">
                    Solicitar Orçamento
                </a>
            </div>
        </div>
