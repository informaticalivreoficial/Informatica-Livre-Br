...
@section('title', 'Cadastrar Fatura')
...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1>Cadastrar nova Fatura</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Painel de Controle</a></li>
            <li class="breadcrumb-item"><a href="{{route('vendas.faturas')}}">Faturas</a></li>
            <li class="breadcrumb-item active">Cadastrar nova Fatura</li>
        </ol>
    </div>
</div> 
@stop
...
<form id="frm" action="{{ route('vendas.faturas.store') }}" method="post" autocomplete="off">
@csrf          
<div class="row">            
    <div class="col-12"> 
