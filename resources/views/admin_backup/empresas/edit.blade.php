                                        ...
                                        <div class="row mb-2">
                                            <div class="col-12 col-md-6 col-lg-2"> 
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control mask-zipcode" id="cep" placeholder="Digite o CEP" name="cep" value="{{old('cep') ?? $empresa->cep}}">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4 col-lg-3"> 
                                                <div class="form-group">
                                                    <label class="labelforms text-muted"><b>*Estado:</b></label>
                                                    <input type="text" class="form-control" id="uf" name="uf" value="{{old('uf') ?? $empresa->uf}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-3"> 
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Endereço Completo" id="rua" name="rua" value="{{old('rua') ?? $empresa->rua}}">
                                                </div>
                                            </div>                                            
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-12 col-md-4 col-lg-3"> 
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Bairro" id="bairro" name="bairro" value="{{old('bairro') ?? $empresa->bairro}}">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6 col-lg-2"> 
                                                <div class="form-group">
