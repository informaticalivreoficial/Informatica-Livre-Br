    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-12 col-sm-6 my-2 text-right">
                <a href="{{route('vendas.faturas.create')}}" class="btn btn-sm btn-default"><i class="fas fa-plus mr-2"></i> Cadastrar Novo</a>
            </div>
        </div>
    </div>        
    <!-- /.card-header -->
            ...
            <table class="table table-bordered table-striped projects">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{$fatura->pedidoObject->getEmpresa->alias_name}}</td> 
